# Prototype audio sources

These three user-selected reference clips come from MyInstants:

- `za-warudo-title.mp3`: https://www.myinstants.com/en/instant/za-warudo-time-stop/
